...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
    ...
    <div class="hidden md:block mx-auto text-slate-500">Showing {{ $students->count() }} entries</div>
    <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0 flex items-center gap-2">
        ...
        <a href="{{ route('print.list-of-students-pdf') }}" class="btn btn-primary shadow-md" target="_blank">
...
<div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
    <table class="table table-report -mt-2" style="width: 100%;">
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center py-8 text-slate-500">No students found.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
...
@endsection
@push('scripts')
<script src="{{ asset('js/reports/print-list-of-students.js') }}?v={{ time() }}"></script>
@endpush
